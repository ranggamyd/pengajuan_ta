...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('manajer/profile') ?>">Profil Saya</a></li>
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <!-- <p class="text-center"><?= $manajer->jafung ?></p> -->
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                        ...
                        <div class="active tab-pane" id="profile">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    <th>Jenis Kelamin</th>
                                    <td>
                                        <?= $manajer->jenis_kelamin = 'L' ? 'Laki-laki' : 'Perempuan'; ?>
                                    </td>
                                </tr>
                                <!-- <tr>
                                    <th>Jabatan Fungsional</th>
                                    <td><?= $manajer->jafung ?></td>
                                </tr> -->
                            </table>
                        </div><!-- /.tab-pane -->

                        <div class="tab-pane" id="settings">
                            <form action="<?= base_url('manajer/profile/update_password') ?>" method="POST" class="form-horizontal">
