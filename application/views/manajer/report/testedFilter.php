...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('manajer/report/lolos_uji') ?>">Laporan</a></li>
            <li class="active">Laporan Judul Skripsi Lolos Uji</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box">
                    ...
                    <form action="<?= base_url('manajer/report/lolos_uji_filter') ?>" method="POST" role="form">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <a href="<?= base_url("manajer/report/lolos_uji_excel/filter?kelas=$kelas&tahun_masuk=$tahun_masuk&prodi=$prodi") ?>" class="btn btn-success btn-block"><i class="fa fa-table"></i> Export ke Excel</a>
                            <a href="<?= base_url("manajer/report/lolos_uji_pdf/filter?kelas=$kelas&tahun_masuk=$tahun_masuk&prodi=$prodi") ?>" class="btn btn-danger btn-block"><i class="fa fa-file"></i> Export ke PDF</a>
                        </div>
                    </form>
                </div><!-- /.box -->
            </div><!-- /.col -->
