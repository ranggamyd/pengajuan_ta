                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php endif ?>
                                <span class="hidden-xs"><?= $this->session->userdata('nama_mahasiswa') ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small><?= $this->session->userdata('npm') ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?= base_url('mahasiswa/profile') ?>" class="btn btn-default btn-flat">Profil</a>
                                    </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment(2) == 'ajuan' || $this->uri->segment(2) == 'findAjuan') echo 'active' ?>">
                        ...
                        <ul class="treeview-menu">
                            <li class="<?php if ($this->uri->segment(2) == 'ajuan') echo 'active' ?>"><a href="<?= base_url('mahasiswa/ajuan') ?>"><i class="fa fa-circle-o"></i> Judul Ajuan Saya</a></li>
                            <li class="<?php if ($this->uri->segment(2) == 'findAjuan') echo 'active' ?>"><a href="<?= base_url('mahasiswa/findAjuan') ?>"><i class="fa fa-circle-o"></i> Cari Judul Ajuan</a></li>
                        </ul>
                    </li>
                    <li class="header">LAINNNYA</li>
                    <li class="<?php if ($this->uri->segment(2) == 'profile') echo 'active' ?>"><a href="<?= base_url('mahasiswa/profile') ?>"><i class="fa fa-circle-o text-aqua"></i> <span>Profil Saya</span></a></li>
                </ul>
            </section>
            <!-- /.sidebar -->
        </aside>