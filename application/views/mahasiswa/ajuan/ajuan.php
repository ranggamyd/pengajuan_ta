...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Daftar Judul Ajuan Saya</li>
        </ol>
    </section>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($ajuan_submit > 0) : ?>
                                                    <a href="<?= base_url('mahasiswa/ajuan/update/') . $data['id_ajuan'] ?>" class="btn btn-block btn-sm btn-success">Update</a>
                                                <?php endif ?>
                                                <a href="<?= base_url('mahasiswa/ajuan/detail/') . $data['id_ajuan'] ?>" class="btn btn-block btn-sm btn-info">Detail</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
