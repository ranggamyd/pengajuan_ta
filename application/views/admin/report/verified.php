                ...
                <div class="box">
                    ...
                    <form action="<?= base_url('admin/report/lolos_verifikasi_filter') ?>" method="POST" role="form">
                        ...
                        <div class="box-footer">
                            <a href="<?= base_url('admin/report/lolos_verifikasi_excel') ?>" class="btn btn-success btn-block"><i class="fa fa-table"></i> Export ke Excel</a>
                            <a href="<?= base_url('admin/report/lolos_verifikasi_pdf') ?>" class="btn btn-danger btn-block"><i class="fa fa-file"></i> Export ke PDF</a>
                        </div>
                    </form>
                </div><!-- /.box -->
            </div><!-- /.col -->
