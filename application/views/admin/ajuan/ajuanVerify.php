        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    <form action="<?= base_url('admin/ajuan/proses_verifikasi') ?>" method="POST" role="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="catatan_verifikasi" id="catatan" class="form-control" rows="5" placeholder="Tuliskan sesuatu .."></textarea>
                            </div>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
