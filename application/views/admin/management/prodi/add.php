        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    <form action="<?= base_url('admin/management/proses_add_prodi') ?>" method="POST" role="form">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="konsentrasi" id="konsentrasi" class="form-control" placeholder="Konsentrasi .." required>
                            </div>
                            <div class="form-group">
