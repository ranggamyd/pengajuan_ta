...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tambah Penguji</li>
        </ol>
    </section>
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Penguji</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form action="<?= base_url('admin/management/proses_add_penguji') ?>" method="POST" role="form">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_penguji" id="nama_penguji" class="form-control" placeholder="Nama Penguji .." required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jafung" id="jafung" class="form-control" placeholder="Jafung .." required>
                            </div>
                        </div><!-- /.box-body -->
