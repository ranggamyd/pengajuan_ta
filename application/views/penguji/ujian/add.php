...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tambah Ajuan</li>
        </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    <form action="<?= base_url('penguji/ujian/proses_add') ?>" method="POST" role="form">
                        ...
                        <div class="box-body">
                            <?php
                            $ph = $this->db->get_where('ta_ujian', ['id_ajuan' => $ajuan->id_ajuan])->num_rows();
                            if ($ph == 0) :
                            ?>
                                <div class="form-group">
                                    <label for="hasil">Hasil Ujian</label>
                                    <select name="hasil_ujian" id="hasil" class="form-control" required>
                                        <option selected disabled>Pilih Hasil Ujian ..</option>
                                        <?php $q = $this->db->get_where('ta_ajuan', ['id_ajuan' => $ajuan->id_ajuan])->row('hasil_ujian'); ?>
                                        <option value="diterima" <?php if ($q == 'diterima') echo 'selected'; ?>>Diterima</option>
                                        <option value="ditolak" <?php if ($q == 'ditolak') echo 'selected'; ?>>Ditolak</option>
                                    </select>
                                </div>
                            <?php endif ?>
                            <div class="form-group">
                                <label for="catatan">Catatan Ujian</label>
                                <textarea name="catatan_penguji" id="catatan" class="form-control" rows="5" placeholder="Tuliskan sesuatu .." required></textarea>
                            </div>
                        </div><!-- /.box-body -->
                        <div class="box-footer">
