...
class Report extends CI_Controller
{
    ...
    public function loadView($file, $data)
    {
        ...
        $this->load->view('manajer/report/' . $file, $data);
    ...
    public function lolos_verifikasi_excel($filter = null)
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('I1', 'Judul 1')
            ->setCellValue('J1', 'Judul 2')
            ->setCellValue('K1', 'Judul 3');
        ...
        foreach ($verified as $data) {
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('I' . $i, $data['judul_1'])
                ->setCellValue('J' . $i, $data['judul_2'])
                ->setCellValue('K' . $i, $data['judul_3']);
    ...
    public function lolos_uji_excel($filter = null)
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('H1', 'Konsentrasi')
            ->setCellValue('I1', 'Judul')
            ->setCellValue('J1', 'Hasil Ujian')
            ->setCellValue('K1', 'Penguji 1')
            ->setCellValue('L1', 'Penguji 2')
            ->setCellValue('M1', 'Catatan Penguji 1')
            ->setCellValue('N1', 'Catatan Penguji 2');
        ...
        foreach ($tested as $data) {
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('H' . $i, $data['konsentrasi'])
                ->setCellValue('I' . $i, $data['judul'])
                ->setCellValue('J' . $i, $data['hasil_ujian'])
                ->setCellValue('K' . $i, $data['penguji_1'])
                ->setCellValue('L' . $i, $data['penguji_2'])
                ->setCellValue('M' . $i, $data['catatan_penguji_1'])
                ->setCellValue('N' . $i, $data['catatan_penguji_1']);
